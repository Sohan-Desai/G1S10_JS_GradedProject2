        ...
        <div class="resume-body">
            ...
            <div class="main-section">
                ...
                <section class="bio-data education" id="education">
                    ...
                    <ul>
                        <li>
                            <b>UG: </b>${filterList[index].education.UG.institute}, ${filterList[index].education.UG.course}, ${filterList[index].education.UG["Start Date"]}, ${filterList[index].education.UG["End Date"]}, ${filterList[index].education.UG.cgpa}
                        </li>
                        <li>
                            <b>PU: </b>${filterList[index].education["Senior Secondary"].institute}, ${filterList[index].education["Senior Secondary"].cgpa}
                        </li>
                        <li>
                            <b>High School: </b>${filterList[index].education["High School"].institute}, ${filterList[index].education["High School"].cgpa}
                        </li>
                    </ul>
                </section>
                ...
                <section class="bio-data achievements" id="achievements">
                    <h2>Achievements</h2>
                    <ul>
                        <li>${filterList[index].achievements.Summary}</li>
                    </ul>
                </section>
            </div>
        </div>
